...
export const areas: Area[] = [
  {
    ...
    postcode: 'G71',
    tagline: 'home turf — the North Calder Water town best known for Tunnock’s',
    summary:
    ...
    landmarks: ['Tunnock’s factory', 'Uddingston railway station', 'Main Street', 'Bothwell Bridge'],
    localFaqs: [
      {
        question: 'Are you actually based in Uddingston?',
        answer:
          'Yes — Uddingston is where KJ Management Accounting Solutions is founded and run from. We work with local businesses in person where it helps, and remotely via Xero for everything else, so you get a local relationship without paying for office overheads you never see.',
      },
      {
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'G71',
    tagline: 'the conservation village next door, home to Bothwell Castle',
    summary:
    ...
    landmarks: ['Bothwell Castle', 'Main Street', 'Bothwell Bridge'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Viewpark Gardens', 'Laighstonehall Road corridor'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Bellshill town centre', 'M8/M74 interchange', 'Bellshill Cultural Centre'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'G72',
    tagline: 'the birthplace of David Livingstone, on the banks of the Clyde',
    summary:
    ...
    landmarks: ['David Livingstone Birthplace museum', 'High Blantyre', 'River Clyde walkway'],
    localFaqs: [
      {
        question: 'Is Blantyre within your local service area?',
        answer:
          'Yes — Blantyre is a short drive from our Uddingston base, so we can meet in person when it is useful, backed by the same Xero-based reporting and monthly accounts we provide to every client, local or remote.',
      },
    ],
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'ML3',
    tagline: 'the historic county town of Lanarkshire',
    summary:
    ...
    landmarks: ['Hamilton Park Racecourse', 'Hamilton town centre', 'Strathclyde Country Park'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Motherwell town centre', 'Strathclyde Country Park', 'Dalzell Estate'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'G73',
    tagline: 'the royal burgh on Glasgow’s southern edge',
    summary:
      'Rutherglen sits right on the boundary with Glasgow, and its Main Street and King Street business community reflects that — independent retailers, tradespeople and consultants who want a Scottish, ACCA-qualified accountant rather than a call centre. We handle bookkeeping and annual accounts here the same way we do for every client: on Xero, reconciled monthly, no surprises at year end.',
    landmarks: ['Main Street', 'King Street', 'Rutherglen Town Hall'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Cambuslang Investment Park', 'Main Street', 'River Clyde'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    summary:
      'Glasgow is home to the largest concentration of small and growing businesses in our service area, from city-centre agencies and consultancies to e-commerce and tech businesses trading nationally. We work with Glasgow-based owners entirely on Xero and video call where that suits them, or in person when a face-to-face meeting is worth the short drive from our Uddingston base.',
    landmarks: ['Glasgow city centre', 'Merchant City', 'Finnieston'],
    localFaqs: [
      {
        question: 'Do you work with businesses across Glasgow, or just the south side?',
        answer:
          'We work with businesses across the whole of Glasgow and its wider commuter belt — city centre, west end, south side and beyond — remotely via Xero and video call, with in-person meetings available given our base just outside the city.',
      },
    ],
  ...
  },
  {
    ...
    landmarks: ['Wishaw town centre', 'Wishaw General Hospital', 'Netherton Cross'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'ML9',
    tagline: 'a former weaving and mining town south of Hamilton',
    summary:
    ...
    landmarks: ['Larkhall Cross', 'Millheugh Bridge', 'Avon Water'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['The Plaza', 'East Kilbride business parks', 'Calderglen Country Park'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'North Lanarkshire',
    postcode: 'ML5',
    tagline: 'the historic “Iron Burgh”, twinned with Airdrie',
    summary:
    ...
    landmarks: ['Summerlee Museum of Scottish Industrial Life', 'Coatbridge town centre'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Airdrie town centre', 'Rawyards', 'Monklands Hospital'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'South Lanarkshire',
    postcode: 'ML10',
    tagline: 'a market town on the edge of the Avon Valley',
    summary:
    ...
    landmarks: ['Strathaven Castle', 'John Hastie Park', 'Strathaven town centre'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Clarkston Toll', 'Clarkston railway station'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    region: 'Renfrewshire',
    postcode: 'PA1–PA3',
    tagline: 'Renfrewshire’s largest town, and a UNESCO Creative City',
    summary:
      'Paisley has one of the biggest and most varied small business communities west of Glasgow, from textile-heritage retailers to businesses trading through Glasgow Airport just up the road. We work with Paisley owners entirely on Xero and video call, giving them the same finance function as a client based five minutes from our door.',
    landmarks: ['Paisley Abbey', 'Paisley town centre', 'Glasgow Airport'],
    localFaqs: [
      {
        question: 'Do you work remotely with businesses based in Paisley?',
        answer:
          'Yes — the majority of our Paisley clients work with us entirely remotely, using Xero and video calls for everything from bookkeeping to monthly management accounts reviews.',
      },
    ],
    nearby: ['glasgow'],
  },
  {
    ...
    postcode: 'G61',
    tagline: 'an affluent suburb on the Antonine Wall, north-west of Glasgow',
    summary:
    ...
    landmarks: ['Bearsden Cross', 'Antonine Wall bathhouse remains'],
    localFaqs: [
      {
  ...
  },
  {
    ...
    landmarks: ['Bishopbriggs town centre', 'Kirkintilloch Road'],
    localFaqs: [
      {
