export type Area = {
  ...
  tagline: string;
  /** 2–3 sentence unique paragraph on why a business owner here would work with KJ Management. */
  summary: string;
...
export const areas: Area[] = [
    ...
    localFaqs: [
      {
        ...
        answer:
          'We work with businesses across the whole of Glasgow and its wider commuter belt, from city centre to west end, south side and beyond, remotely via cloud accounting and video calls, with in-person meetings available given our base just outside the city.',
      },
    ],
  ...
  },
  {
    ...
    summary:
      'Coatbridge’s industrial heritage lives on in a modern base of trades, manufacturing and logistics businesses. These are owners for whom cash flow is everything, with materials, wages and supplier terms all moving at once, which is exactly what our cash flow planning and bookkeeping services are built to keep on top of.',
